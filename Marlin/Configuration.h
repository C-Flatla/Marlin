...
#define STRING_CONFIG_H_AUTHOR "(Cody Flatla, Anet SKR 1.4 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AM8 SKR 1.4"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 166.61
  #define DEFAULT_bedKi 26.36
  #define DEFAULT_bedKd 702.15
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.92, 80.18, 400, 393.458 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -5, -35, -2 }
